...
map({ "n", "i", "v", "c" }, "<C-c>", "<ESC>")
map("t", "<ESC>", "<C-\\><C-n>")
map("n", "<leader>w", function() vim.cmd("bd") end, { desc = "close buffer", noremap = true, silent = true })
map("n", "<leader>q", function() vim.cmd("qa") end, { desc = "quit", noremap = true, silent = true })
